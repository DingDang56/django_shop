    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('commodity_picture', models.ImageField(upload_to='static/images')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.ForeignKey(on_delete=True, to='Buyer.BuyUser')),
            ],
        ),
        migrations.CreateModel(
            name='OrderResource',
            fields=[
                ...
                ('small_id', models.ForeignKey(on_delete=True, to='Buyer.Order')),
        ...
        migrations.AddField(
            model_name='address',
            name='buyer_id',
            field=models.ForeignKey(on_delete=True, to='Buyer.BuyUser'),
        ),
    ]
