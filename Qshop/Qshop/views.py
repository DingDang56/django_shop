...
# def sendMessage(requeset):
#     result = {"state":"error","data":""}
#     try:
#         message=send_mail("来自Django邮件","大家上午好",sender,["2081734917@qq.com"])
...
def sendMessage(request):
    result = {"state":"error","data":""}
    try:
        message = EmailMultiAlternatives("老边的邮件","hello world",sender,["2081734917@qq.com"])
        message.send()
    except Exception as e:
        result["data"] = str(e)
    else:
